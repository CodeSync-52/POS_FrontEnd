         ...
         <q-card>
           <q-card-section>
             ...
             <div class="row px-2 q-col-gutter-y-md">
               ...
               <div class="col-4">
                  <div>
                     <q-input v-model="itemsPerPage" type="number" label="Items Per Page" />
                  </div>
               </div>
               <div class="col-12">
                  <div class="row items-center q-gutter-x-md">
                     <span>Permissions:</span>
                     <span>Select all: <q-toggle v-model="selectAllRoles" color="red" /></span>
                  </div>
               </div>
               <div class="col-12">
                     ...
                     <div class="col-3">
                        <div>
                           <div class="row q-gutter-x-md">
                              <span>View All:</span>
                              <q-toggle v-model="viewAllRoles" @click='handleViewAllRoles' color="red" />
                           </div>
                        </div>
                     </div>
                     <div class="col-3">
                        <div>
                           <div class="row q-gutter-x-md">
                              ...
                              <q-toggle v-model="createAllRoles" color="red" @click="handleCreateAllRoles" :disable="!viewAllRoles" />
                           </div>
                        </div>
                     </div>
                     <div class="col-3">
                        <div>
                           <div class="row q-gutter-x-md">
                              <span>Edit All:</span>
                              <q-toggle v-model="editAllRoles" color="red" @click="handleEditAllRoles" :disable="!viewAllRoles" />
                           </div>
                        </div>
                     </div>
                     <div class="col-3">
                        <div>
                           <div class="row q-gutter-x-md">
                              ...
                              <q-toggle v-model="deleteAllRoles" color="red" @click="handleDeleteAllRoles" :disable="!viewAllRoles" />
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <q-markup-table flat bordered class="full-width">
                  ...
                  <tbody>
                     <tr v-for="roles in addAdminRoleTableData" :key="roles.role">
                        ...
                        <td class="text-left">{{ roles.role }}</td>
                        <td class="text-left"><q-toggle v-model="roles.view" color="red" @click="handleSingleViewToggle(roles)" /></td>
                        <td class="text-left"><q-toggle v-model="roles.create" color="red" @click="handleSingleCreateToggle" :disable="!roles.view" /></td>
                        <td class="text-left"><q-toggle v-model="roles.edit" color="red" @click="handleSingleEditToggle" :disable="!roles.view" /></td>
                        <td class="text-left"><q-toggle v-model="roles.delete" color="red" @click="handleSingleDeleteToggle" :disable="!roles.view" /></td>
                     </tr>
                  </tbody>
               </q-markup-table>
             </div>
...
const addAdminRoleTableData = ref([
   {id:1,role:'Dashboard', view:false,create:false,edit:false,delete:false},
   {id:2,role:'Team',view:false,create:false,edit:false,delete:false},
   {id:3,role:'Videos',view:false,create:false,edit:false,delete:false},
   {id:4,role:'Blog', view:false,create:false,edit:false,delete:false},
   {id:5,role:'Users', view:false,create:false,edit:false,delete:false},
])
...
const handleViewAllRoles=()=>{
   if(!viewAllRoles.value){
     ...
     addAdminRoleTableData.value.forEach(role=>{role.edit = editAllRoles.value
   role.create = createAllRoles.value 
   role.delete = deleteAllRoles.value})
   }
   addAdminRoleTableData.value.forEach(role=>role.view = viewAllRoles.value)
}
const handleCreateAllRoles=()=>{
   addAdminRoleTableData.value.forEach(role=>role.create = createAllRoles.value)
}
const handleEditAllRoles=()=>{
   addAdminRoleTableData.value.forEach(role=>role.edit = editAllRoles.value)
}
const handleDeleteAllRoles=()=>{
   addAdminRoleTableData.value.forEach(role=>role.delete = deleteAllRoles.value)
}
const handleSingleViewToggle =(role:{id:number,role:string,view:boolean,create:boolean,edit:boolean,delete:boolean})=>{
